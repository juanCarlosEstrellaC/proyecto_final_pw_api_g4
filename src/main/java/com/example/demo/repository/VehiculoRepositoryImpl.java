...
public class VehiculoRepositoryImpl implements IVehiculoRepository {
	...
	public List<VehiculoDTO> buscarVehiculosPorMarcayModelo(String marca, String modelo) {
		...
		Query myQuery = this.entityManager.createQuery(
				"SELECT NEW com.example.demo.repository.modelo.DTO.VehiculoDTO(v.placa, v.modelo, v.marca, v.anioFabricacion, v.estado, v.renta, v.reservas) "
	...
	public List<Vehiculo> buscarVehiculosPorMarcayModelo22(String marca, String modelo) {
		Query myQuery = this.entityManager
				.createQuery("SELECT v FROM Vehiculo v WHERE v.marca =:datoMarca AND v.modelo =: datoModelo");
		myQuery.setParameter("datoMarca", marca);
		myQuery.setParameter("datoModelo", modelo);
		return myQuery.getResultList();
	}
