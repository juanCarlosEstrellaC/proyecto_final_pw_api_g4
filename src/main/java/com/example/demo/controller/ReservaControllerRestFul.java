...
public class ReservaControllerRestFul {
	 ...
	 * 
	 * @GetMapping(path = "/reporte", produces = "application/json") public
	 * ResponseEntity<List<ReporteTO>> reporte(@RequestParam String
	 * fechaInicio, @RequestParam String fechaFin) {
	 * 
	 * 
	 * 
	 * 
	 * DateTimeFormatter isoFecha= DateTimeFormatter.ofPattern("yyyy-MM-dd"); //var
	 * fechaa= LocalDate.parse(fechaFin, isoFecha); var
	 * fechaf=LocalDateTime.parse(fechaFin, isoFecha); // LocalDate a=
	 * LocalDate.parse(fechaFin);
	 * 
	 * // List<ReporteTO> lista = this.iReservaService.Reporte(fechaInicio,
	 * fechaFin); System.out.println(isoFecha); System.out.println(fechaf); //
	 * System.out.println(lista); return
